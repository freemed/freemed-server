...
require (
	github.com/freemed/freemed-server/common v0.0.0-20240508003353-267a6ce88892
	github.com/freemed/freemed-server/config v0.0.0-20240508003353-267a6ce88892
...
require (
	...
	github.com/freemed/remitt-server/model v0.0.0-20250203225640-8b7510789299 // indirect
