...
require (
	github.com/freemed/freemed-server/common v0.0.0-20250204190741-cc4a799de4af
	github.com/freemed/freemed-server/config v0.0.0-20250204190741-cc4a799de4af
